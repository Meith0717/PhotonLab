...
namespace PhotonLab
{
    ...
    {
        public static bool IntersectsRay(this BoundingBox box, ref Ray ray, Matrix transform, out float t)
        {
            t = 0f;
            ...
            var min = Vector3.Transform(box.Min, transform);
            var max = Vector3.Transform(box.Max, transform);
