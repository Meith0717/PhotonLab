...
namespace PhotonLab.Source.RayTracing
{
    internal readonly struct BarycentricCoordinates
    {
        ...
        public Vector3 InterpolateVector3(in Vector3 v0, in Vector3 v1, in Vector3 v2) =>
            B0 * v0 + B1 * v1 + B2 * v2;

        public Vector2 InterpolateVector2(in Vector2 v0, in Vector2 v1, in Vector2 v2) =>
            B0 * v0 + B1 * v1 + B2 * v2;
    }
}
